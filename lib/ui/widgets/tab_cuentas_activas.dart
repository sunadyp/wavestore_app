...
class TabCuentasActivas extends StatefulWidget {
  const TabCuentasActivas({super.key});

  @override
  State<TabCuentasActivas> createState() => _TabCuentasActivasState();
}

class _TabCuentasActivasState extends State<TabCuentasActivas> {
